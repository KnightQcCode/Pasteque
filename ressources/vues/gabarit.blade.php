...
<html lang="Fr">
    ...
    <body>
    <noscript>
        <p>Le JavaScript n'est pas activé dans votre navigateur. Nous vous recommandons de l'activer afin d'améliorer votre
        ...
        <script src="../node_modules/requirejs/require.js" data-main="liaisons/js/app/app.js"></script>
    </body>
</html>
